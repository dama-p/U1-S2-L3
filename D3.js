...
/* Usare un FOR LOOP perchè lo SWITCH CASE viene ripetuto per ogni personaggio */

for (let i = 0; i < starWarsCharacters.length; i++) {
  const starWarsObj = starWarsCharacters[i];
  const color = starWarsObj.eye_color;
...
/* Si utilizza la variabile index per far partire il ciclo  */
